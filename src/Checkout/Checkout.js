...
const Checkout = () => {
  ...
  const shippingInformationHandle = (event) => {
    setShippingData((prevState) => ({
      ...prevState,
      [event.target.name]: event.target.value,
    }));
            ...
            {shipping ? (
                    ...
                    <form>
                      ...
                      >
                        <TextField
                          ...
                          onChange={shippingInformationHandle}
                          required
                        />
                      </Box>
                      ...
                      <div className="shipping-form-container-devider">
                        <Box
                          className="form-container-devider-box-1"
                        ...
                        <Box
                          className="form-container-devider-box-2"
                          sx={{ width: "100%", maxWidth: "100%" }}
                        >
                          <TextField
                            fullWidth
              ...
              <>
                <div className="payment-container">
                  ...
                  <p className="payment-option-notice">
                    For more on how Protein Writer uses and protects your
                    information, please read our{" "}
                    <NavLink to="/privacypolicy" className="payment-navlink">
                      Privacy Policy
                    </NavLink>{" "}
                    and{" "}
                    <NavLink to="/rules" className="payment-navlink">
                      Rules of Road.
                    </NavLink>
                  </p>
                  ...
                  {paypal && (
                    <>
                      <button className="payment-submit-btn">
                        <i className="fa-brands fa-paypal paypal-icon"></i>
                        <p>Checkout</p>
                      </button>
                    </>
                  )}
