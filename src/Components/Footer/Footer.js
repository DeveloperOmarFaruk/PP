      ...
      <div className="footer-section">
          ...
          <div className="footer-col-9">
            <div className="footer-right-container">
              <dev className="footer-right-container-box">
                <div className="footer-right-container-box-design">
                  ...
                  <ul>
                    ...
                    <li>
                      <NavLink to="/contact-us" className="footer-navlink">
                        Contact Us
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/faq" className="footer-navlink">
                        FAQs
                      </NavLink>
                    </li>
                    ...
                    <li>
                      <NavLink to="/rules" className="footer-navlink">
                        Terms of Use
                      </NavLink>
                    </li>
                  </ul>
              ...
              {/* <div className="contact-us-box">
                <div
                  className="footer-right-container-box-design"
                  style={{ margin: "0px" }}
                >
                  <p>Contact Us</p>
        ...
        <div className="footer-copywrite-social-container">
          <div className="footer-copywrite-container">
            <p>
              <i class="fa-regular fa-copyright"></i> Copyright 2023 My Protein
