...
const Navbar = () => {
  ...
  const { authState, cartState, authDispatch } = useContext(GlobalContext);

  useEffect(() => {
    setTotalItem(cartState.total);
  }, [cartState]);
          ...
          <nav className="navbar">
            ...
            <ul className="menu">
              <li className="has-dropdown">
                <NavLink to="/protein-design" className="menu-link">
                  Protein Design &nbsp;
                ...
                <ul className="submenu">
                  ...
                  <li>
                    <NavLink
                      to="/protein-design?type=bacteria"
                      className="menu-link"
                    >
                      Bacteria
                    </NavLink>
              ...
              <li>
                <NavLink to="/how-it-works" className="menu-link">
                  How It Works
                </NavLink>
              </li>
                ...
                <ul className="submenu">
                  ...
                  <li>
                    <NavLink
                      ...
                      className="menu-link menu-link-respons"
                    >
                      ProteinLab Analysis
                    </NavLink>
                  </li>
              ...
              {authState.is_authenticated ? (
                <li>
                  <button onClick={makeUserLogout} className="menu-link">
                    Log Out
                  </button>
                </li>
              ) : (
