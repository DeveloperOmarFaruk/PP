        ...
        <div className="pdesign-card-btn">
          <div className="pdesign-card-info">
            <div className="row">
              ...
              <div
                className="col-xl-8 col-lg-8 col-md-8 col-sm-8  hover-text"
                style={{ margin: "20px auto 0px auto" }}
              >
                {/* <p>{item.organism_name}</p> */}
                <p className="pdesign-card-organism">
                  {item.organism_name}
            ...
            <div className="row">
              ...
              <div
                ...
                style={{ margin: "0px" }}
              >
                <p className="pdesign-card-protein">
                  {item.protein_name}
                  <span className="tooltip-text" id="right">
                    {item.protein_name}
                  </span>
          ...
          <div className=" row pdesign-card-chart-btn">
            ...
            <div
              ...
              onClick={() =>
                navigate(`/order/${item.id}`, { state: { id: index } })
              }
            >
